...
const EditCatalogContent = () => {
  ...
  if (pageLoading) {
    return (
      <div className="relative flex min-h-screen w-full flex-col max-w-md md:max-w-3xl mx-auto bg-brand-bg text-brand-text font-sans items-center justify-center">
